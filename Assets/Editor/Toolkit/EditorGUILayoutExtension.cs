...
namespace CTEditor.toolkit
{
    public static partial class EditorGUILayoutExtension
    {
        ...
        {
            LinkFileLabelField_internal(new GUIContent(label), AssetDatabase.LoadAssetAtPath<Object>(assetPath),
                options);
        }
        ...
        private static void LinkFileLabelField_internal(GUIContent label, Object linkObject,
